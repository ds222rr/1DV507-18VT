...
public class CountrySort {
	...
	public static void main(String[] args) {
		...
		Comparator<String> countAs = (s1,s2) -> (int) (numberOfAs(s2)-numberOfAs(s1));
	...
	public static long numberOfAs(String string) {	// Method to determine the number of As in a String
		return string.chars().filter(ch -> ch == 'a' || ch == 'A').count();
	}
